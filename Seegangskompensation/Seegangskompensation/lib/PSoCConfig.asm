...
export LoadConfig_seegangskompensation
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_seegangskompensation
	lcall	LoadConfigTBL_seegangskompensation_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration seegangskompensation
;
;    Load configuration registers for seegangskompensation.
...
;               CUR_PP
;
_LoadConfig_seegangskompensation:
 LoadConfig_seegangskompensation:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_seegangskompensation_Bank0
    mov     X, <LoadConfigTBL_seegangskompensation_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_seegangskompensation_Bank1
    mov     X, <LoadConfigTBL_seegangskompensation_Bank1
