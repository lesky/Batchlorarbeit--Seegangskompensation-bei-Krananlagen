...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: IN2_Start(void)
;  FUNCTION NAME: IN2_Stop(void)
;
;  FUNCTION NAME: IN2_Switch(void)
;
;  DESCRIPTION: ( Switch )
;     Turn LED on or off     
;
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: IN2_GetState(void)
;
;  DESCRIPTION:
;     Get state of LED
;
...
ENDIF
   and   A,IN2_PinMask                 ; Mask off the trash
