...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: IN1_Start(void)
;  FUNCTION NAME: IN1_Stop(void)
;
;  FUNCTION NAME: IN1_Switch(void)
;
;  DESCRIPTION: ( Switch )
;     Turn LED on or off     
;
...
IF(0)                                            ; Active High Digit Drive
   or   [Port_1_Data_SHADE],IN1_PinMask
ELSE                                             ; Active Low Digit Drive
   and  [Port_1_Data_SHADE],~IN1_PinMask
ENDIF
   jmp  .Switch_LED
...
_IN1_Invert:
 IN1_Invert:
   ...
   xor  [Port_1_Data_SHADE],IN1_PinMask
   mov  A,[Port_1_Data_SHADE]
   mov  reg[IN1_PortDR],A
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: IN1_GetState(void)
;
;  DESCRIPTION:
;     Get state of LED
;
...
ENDIF
   and   A,IN1_PinMask                 ; Mask off the trash
