...
_I2Cm_Start:
    ...
    or   [Port_1_DriveMode_1_SHADE],I2Cm_SDA_pin|I2Cm_SCL_pin
    and  [Port_1_DriveMode_0_SHADE],~(I2Cm_SDA_pin|I2Cm_SCL_pin)

IF(I2Cm_DriveMode2)            
    and  [Port_1_DriveMode_2_SHADE],~(I2Cm_SDA_pin|I2Cm_SCL_pin)
...
ENDIF
    ...
    and  [Port_1_Data_SHADE],~(I2Cm_SDA_pin|I2Cm_SCL_pin)
...
I2C_DoRepeatStart:
    ...
    push  a
    M8C_SetBank1
    or    [Port_1_DriveMode_0_SHADE],I2Cm_SCL_pin          ; Assert SCL low
    and   [Port_1_DriveMode_0_SHADE],~I2Cm_SDA_pin         ; Release SDA high
    mov   A,[Port_1_DriveMode_0_SHADE]
    mov   reg[I2Cm_I2CPRTDM0],A
    ...
    call  I2Cm_delay
                                                           ; Release SCL high
    and   [Port_1_DriveMode_0_SHADE],~I2Cm_SCL_pin
    mov   A,[Port_1_DriveMode_0_SHADE]
    mov   reg[I2Cm_I2CPRTDM0],A
...
I2C_DoStart:
    ...
    or    [Port_1_DriveMode_0_SHADE],I2Cm_SDA_pin               ; Assert SDA low
    mov   A,[Port_1_DriveMode_0_SHADE]
    mov   reg[I2Cm_I2CPRTDM0],A
    ...
    RAM_SETPAGE_CUR >Port_1_DriveMode_0_SHADE
    M8C_SetBank1
    or    [Port_1_DriveMode_0_SHADE],I2Cm_SCL_pin               ; Set SCL low
    mov   A,[Port_1_DriveMode_0_SHADE]
    mov   reg[I2Cm_I2CPRTDM0],A
    M8C_SetBank0
...
writenextbit:
    ...
    RAM_SETPAGE_CUR >Port_1_DriveMode_0_SHADE
                                                           ; Assert SCL low
    M8C_SetBank1
    or    [Port_1_DriveMode_0_SHADE],I2Cm_SCL_pin
    mov   A,[Port_1_DriveMode_0_SHADE]
    mov   reg[I2Cm_I2CPRTDM0],A
    M8C_SetBank0
    ...
    or    [Port_1_DriveMode_0_SHADE],I2Cm_SDA_pin
    mov   A,[Port_1_DriveMode_0_SHADE]
    mov   reg[I2Cm_I2CPRTDM0],A

    jmp   writestartclock
write_bit:                                                 ; Release SDA high for data 1
    and   [Port_1_DriveMode_0_SHADE],~I2Cm_SDA_pin      
    mov   A,[Port_1_DriveMode_0_SHADE]
    mov   reg[I2Cm_I2CPRTDM0],A
...
_I2Cm_SendStop:
    ...
    or    [Port_1_DriveMode_0_SHADE],I2Cm_SCL_pin|I2Cm_SDA_pin
    mov   A,[Port_1_DriveMode_0_SHADE]
    mov   reg[I2Cm_I2CPRTDM0],A
